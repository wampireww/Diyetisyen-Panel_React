...
import { _Arsivegonder, _Danisansil, _Donemsil, _Dosyasil, _Notsil, _Seanssil, _Tahsilatsil } from '../components/Firebaseislemleri';
import { useNavigate } from 'react-router-dom';
import ForwardIcon from '@mui/icons-material/Forward';

export const Marsiv=({baslik,govde,dankey})=> {
...
const Sil=()=>{
  ...
  return (
    <div>
       ...
       <ForwardIcon style={{color:"#455A64"}} />
      </IconButton>
